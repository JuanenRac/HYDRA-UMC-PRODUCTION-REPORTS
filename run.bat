...
REM *****************************************************************************
REM Project   : HYDRA-UMC-PRODUCTION-REPORTS
REM Script    : run.bat
...
echo.
echo *****************************************************************************
echo * HYDRA-UMC-PRODUCTION-REPORTS - run.bat
...
REM Runs HYDRA-UMC-PRODUCTION-REPORTS's entry point. Run build.bat first.
cd /d "%~dp0"
