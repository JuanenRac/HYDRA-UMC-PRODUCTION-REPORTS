...
Servizio puramente software (generazione di report) - senza hardware/firmware/os propri, rimossi dal template (vedi la convenzione dell'ecosistema in `SONNET/_papelera/`).
